...
>
> ![image-20210412193403720](image/image-20210412193403720.png)
>
> > ```java
> > class Solution {
...
>
> ![img](image/6ec72e221775fad0d67a787be280257749612ca3ad8eb1799209cd0f1f12ed14.jpg)
>
> ![image-20210414203302245](image/image-20210414203302245.png)
>
> > ```java
> > class Solution {
> >     public int[] getLeastNumbers(int[] arr, int k) {
...
> [2,3] 的中位数是 (2 + 3) / 2 = 2.5
>
> ![image-20210415142509299](image/image-20210415142509299.png)
...
>
> ![image-20210415143451602](image/image-20210415143451602.png)
>
> ![image-20210415143507373](image/image-20210415143507373.png)
>
> > ```java
> > class MedianFinder {
> > 
...
> ![image-20210415190806825](image/image-20210415190806825.png)
>
> ![image-20210415190842674](image/image-20210415190842674.png)
>
> ![image-20210415190857509](image/image-20210415190857509.png)
>
> ![image-20210415190907881](image/image-20210415190907881.png)
>
> ```java
...
> ![image-20210415195542338](image/image-20210415195542338.png)
>
> - 第一步，确定数字$n$所在数字的位数，记作$digit$。
>
>   ![image-20210415195652820](image/image-20210415195652820.png)
>
> - 确定 $n$ 所在的 **数字** ，记为 $num$ ；
>
>   ![image-20210415195746096](image/image-20210415195746096.png)
>
> - 确定 $n$是$num$中的哪一数位，并返回结果。
>
> ![image-20210415200259838](image/image-20210415200259838.png)
>
> > ```java
> > class Solution {
...
> ![img](image/e231fde16304948251633cfc65d04396f117239ea2d13896b1d2678de9067b42-Picture1.png)
>
> > ```java
...
> ![image-20210416171628235](image/image-20210416171628235.png)
>
> > ```java
> > class Solution {
...
>
> ![image-20210417193044434](image/image-20210417193044434.png)
>
> > ```java
...
>
> ![image-20210419204635189](image/image-20210419204635189.png)
>
> > ```java
> > class Solution {
> >     public char firstUniqChar(String s) {
...
> >![image-20210420150119168](image/image-20210420150119168.png)
> >
> >![image-20210420150129794](image/image-20210420150129794.png)
> >
> >```java
...
> 输入两个链表，找出它们的第一个公共节点。
>
> ![image-20210420123605801](image/image-20210420123605801.png)
...
> > 其他思路：
> >
> > > ![image-20210420140518522](image/image-20210420140518522.png)
> > >
...
> > > > >
> > > > > ![image-20210420141502391](image/image-20210420141502391.png)
> > > > >
...
>
> ![image-20210420153152361](image/image-20210420153152361.png)
>
> > ```java
> > class Solution {
> >     public int missingNumber(int[] nums) {
...
>
> ![image-20210420201642583](image/image-20210420201642583.png)
...
>
> ![image-20210420202021140](image/image-20210420202021140.png)
>
> > ```java
> > /**
> >  * Definition for a binary tree node.
...
>
> ![image-20210420205919215](image/image-20210420205919215.png)
...
>
> > ![image-20210420214537644](image/image-20210420214537644.png)
...
>
> ![image-20210421092041761](image/image-20210421092041761.png)
>
...
>
> ![image-20210421100006574](image/image-20210421100006574.png)
...
> ![image-20210423105604143](image/image-20210423105604143.png)
>
...
>
> ![image-20210423163810896](image/image-20210423163810896.png)
>
> > ```java
> > class MaxQueue {
> >     Queue<Integer> queue;
...
>
> ![image-20210423192007628](image/image-20210423192007628.png)
>
...
>
> ![image-20210423192301873](image/image-20210423192301873.png)
>
...
max - min < 5
$$
![image-20210423202825246](image/image-20210423202825246.png)
...
> ![image-20210423211528051](image/image-20210423211528051.png)
...
> 感觉这样跟动态规划很像：
>
> ![image-20210423215618655](image/image-20210423215618655.png)
>
> > ```java
> > class Solution {
> >     public int maxProfit(int[] prices) {
...
> ![image-20210424093113300](image/image-20210424093113300.png)
>
> > ```java
> > class Solution {
...
>
> ![image-20210424094436466](image/image-20210424094436466.png)
>
> ![image-20210424094512221](image/image-20210424094512221.png)
>
> ```java
...
>  按照对角线讲数组分成左右两部分。
>
> ![image-20210424101747457](image/image-20210424101747457.png)
>
> > ```java
> >     public int[] ConstructArr(int[] a){
> >         if (a==null || a.length==0)
...
> ![image-20210424122600558](image/image-20210424122600558.png)
>
> ![image-20210424122159976](image/image-20210424122159976.png)
>
> > ```java
> > class Solution {
...
>
> ![image-20210424135548350](image/image-20210424135548350.png)

##### 分析：

> 最近公共祖先的定义： 设节点 $ root$ 为节点 $ p,q$ 的某公共祖先，若其左子节点 $root.left$ 和右子节点$ root.right$都不是$p,q $的公共祖先，则称 $root$ 是 “最近的公共祖先” 。

![image-20210424135858104](image/image-20210424135858104.png)

![image-20210424135945505](image/image-20210424135945505.png)
...
> 例如，给定如下二叉树:$ root = [3,5,1,6,2,0,8,null,null,7,4]$，
>
> ![image-20210424170223548](image/image-20210424170223548.png)

##### 方法：DFS

> 最近公共祖先的定义： 设节点 $root$ 为节点$ p, q$ 的某公共祖先，若其左子节点$ root.left$ 和右子节点$ root.right$ 都不是$ p,q$ 的公共祖先，则称$ root$ 是 “最近的公共祖先” 。
>
> ![image-20210424170442479](image/image-20210424170442479.png)
>
> ![image-20210424170524837](image/image-20210424170524837.png)
>
> > ```java
> > /**
> >  * Definition for a binary tree node.
